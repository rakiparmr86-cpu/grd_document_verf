...
type CaseDocument = {id:string;filename:string;document_type:string;detected_file_type:string;size_bytes:number;page_count:number;password_protected:boolean;status:string;malware_scan_status:string;storage_available:boolean;storage_deleted_at:string|null;observations:string[];updated_at:string}
